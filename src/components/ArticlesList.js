...
import { FileText, Search, Calendar, Tag, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <section className="relative bg-slate-900 text-white py-20 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Kumpulan artikel, tutorial, dan panduan tentang teknologi, pemrograman, dan pengembangan
            aplikasi yang saya tulis berdasarkan pengalaman dan penelitian.
          </p>
        </div>
      </section>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(article.tags || []).slice(0, 3).map((tag, index) => (
                          <span
                            key={index}
                            className="px-2 py-1 bg-slate-100/80 dark:bg-slate-800/80 backdrop-blur-sm text-slate-700 dark:text-slate-300 text-xs rounded flex items-center border border-slate-200/50 dark:border-slate-700/50"
                          >
            ...
            <div className="mt-8 text-center">
              <div className="inline-flex items-center px-6 py-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-xl border border-white/20 dark:border-slate-700/50 shadow-lg">
                <p className="text-slate-600 dark:text-slate-400 font-medium">
                  Menampilkan {startIndex + 1}-{Math.min(endIndex, filteredArticles.length)} dari{' '}
